...
For diagrams already identified in chapter JSON, use the [keyframe capture tool](docs/KEYFRAME_CAPTURE.md). It saves timestamped PNGs, a manifest, and a review gallery from local or matching YouTube videos.
