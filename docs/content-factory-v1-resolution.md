...
Open inputs: target learner confirmation; named subject/editorial reviewer and learner access; publishing permissions and authoritative supplemental sources; verified optics source order and skipped-source disposition; zIDE integration/remaining-quota evidence; numeric run/pilot token allocations after an estimate. These are required evidence and authorization, not values to invent. Unanswered inputs block their dependent model-dispatch/release steps while offline preparation continues.
